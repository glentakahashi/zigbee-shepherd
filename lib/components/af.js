...
af.zclClusterAttrsReq = function (dstEp, cId, interestedValue, callback) {
    ...
    return Q(af.controller.limitConcurrency(()=>af.zclClusterAttrIdsReq(dstEp, cId), dstEp.getIeeeAddr())).then(function (attrIds) {
        var attributes = []
        ...
        _.forEach(attrIds, function (id) {
            ...
            if (readReq.length === 5 || readReq.length === attrIdsLen) {
                ...
                attrsReqs.push(function () {
                    ...
                    return af.controller.limitConcurrency(()=>af.zclFoundation(dstEp, dstEp, cId, 'read', req), dstEp.getIeeeAddr())
                        .then(
                            ...
                            function(){
                                ...
                                req.forEach(function(r){
                                    singleChain = singleChain.then(function(){
                                        af.controller.limitConcurrency(()=>af.zclFoundation(dstEp, dstEp, cId, 'read', [r]), dstEp.getIeeeAddr())
