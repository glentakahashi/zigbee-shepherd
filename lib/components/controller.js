...
if(typeof nwkAddr == "undefined") return Q();
    ...
    return this.request('ZDO', 'nodeDescReq', { dstaddr: nwkAddr, nwkaddrofinterest: nwkAddr }).timeout(5000).fail(function (err) {
		console.log("["+ieeeAddr+" / "+nwkAddr+"] check online NDR fails "+ err)
...
Controller.prototype.endDeviceAnnceHdlr = function (data) {
	...
	//this.getShepherd()._devbox.remove(dev._getId(), function () {});
        this.emit('ind:rejoin', data.ieeeaddr);
        return;
    }
